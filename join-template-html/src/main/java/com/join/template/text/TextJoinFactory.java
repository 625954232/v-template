...
public class TextJoinFactory extends AbstractJoinFactory implements JoinFactoryBuilder {
    ...
    public Template putTemplate(String name, String content) {
        return new TextTemplate(this.build(), name, content);
    }
    ...
    public Template getTemplate(String fileName) {
        ...
        return new TextTemplate(this.build(), name, text);
    }
